...
- **New protocol control subtypes** — `KeepaliveAck` (0x18), `QualityReport` (0x19), `AdaptiveHint` (0x1A) with full encode/decode in `protocol.rs`.
...
- **Новые control subtype протокола** — `KeepaliveAck` (0x18), `QualityReport` (0x19), `AdaptiveHint` (0x1A) с полным encode/decode в `protocol.rs`.
