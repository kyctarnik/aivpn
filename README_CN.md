...
crates/aivpn-android-core/ — Android JNI 桥接
crates/aivpn-windows/ — Windows GUI（egui/eframe）
platforms/android/    — Android Kotlin 应用
platforms/macos/      — macOS SwiftUI 菜单栏应用
crates/aivpn-ios-core/ — iOS Rust 静态库（C FFI）
platforms/ios/        — iOS SwiftUI 应用 + NEPacketTunnelProvider
